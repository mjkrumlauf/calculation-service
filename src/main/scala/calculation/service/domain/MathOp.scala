...
case class Exponentiate(base: Double, exponent: Double) extends MathOp
...
case class ExponentiationResult(base: Double, exponent: Double, result: Double) extends MathResult
